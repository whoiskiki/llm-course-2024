...
class Trainer:
    ...
    >>> train_data = MyDataset(train_texts, tokenizer, max_length=128)  # Ваш тренировочный датасет
    ...
    def calc_loss(self, logits: Tensor, y: Tensor) -> Tensor:
        ...
        """
        # вроде надо преобразовать размеры тензоров
    ...
    def train(self) -> None:
        ...
        for _ in range(self.n_epochs):
            for ids in self.train_loader:
                ...
                #тут происходит зануление градиентов + backpropagation + optimizer
